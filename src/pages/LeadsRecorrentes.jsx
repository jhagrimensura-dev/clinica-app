      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-7 space-y-5">
        ...
        <div>
          ...
          <textarea value={obs} onChange={e => setObs(e.target.value)}
            ...
            rows={3} className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-teal-400 resize-none" />
        </div>
        ...
        <div className="flex justify-end gap-3 pt-1">
          ...
          <button onClick={handleSalvar} disabled={!paciente.trim()}
            className="px-6 py-2.5 bg-teal-500 hover:bg-teal-600 text-white text-sm font-semibold rounded-xl transition-colors disabled:opacity-40">
            Criar
          </button>
        </div>
      </div>
    ...
    <div className="p-6 space-y-5">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
          ...
          <p className="text-xs text-gray-400 mt-1">{leads.length} leads recorrentes</p>
        </div>
        <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
          <div className="flex justify-between items-start mb-1">
